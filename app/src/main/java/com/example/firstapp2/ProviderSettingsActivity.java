...
public class ProviderSettingsActivity extends AppCompatActivity {
    private EditText mNameField, mPhoneField, mLocationField;
    ...
    private DatabaseReference mProvidersDatabase;
    ...
    private KeyPairGenerator Places;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProvidersDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child("Providers").child(userID);
    ...
    private void getUserInfo(){
        mProvidersDatabase.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() && snapshot.getChildrenCount()>0) {
                    ...
                    {
                        mService= map.get("location").toString();
                        switch (mService)
                        {
                            case "electrician":
                            ...
                            case "Plumber":
                                ...
                                break;
                            case "ISP":
                                mRadioGroup.check(R.id.ISP);
                                break;
                            case "House Shifting":
                                mRadioGroup.check(R.id.houseshifting);
                                break;
                        }
    ...
    private void saveUserInformation()  {
        ...
        userInfo.put("location", mLocation);
        userInfo.put("service", mService);


        mProvidersDatabase.updateChildren(userInfo);
        ...
        if(resultUri!= null)
        {
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    mProvidersDatabase.updateChildren(newImage);
